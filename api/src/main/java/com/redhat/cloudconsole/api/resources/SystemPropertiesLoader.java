...
public class SystemPropertiesLoader {
    ...
    void initialise() {
        ...
        try {
            ...
            File localSettings = new File(System.getProperty("user.home") + "/cloudconsole.properties");
            if(localSettings.exists()) {
                settingsStream = new FileInputStream(localSettings);
            } else {
                settingsStream = SystemPropertiesLoader.class
                        .getClassLoader()
                        .getResourceAsStream("com/redhat/cloudconsole/api/resources/cloudconsole.properties");
            }
